...
export const ProfileMahasiswa = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            // whatsapp may not be in user type yet
        }
    }, [user])
    ...
    const handleUpdateWhatsapp = () => {
        console.log('Updating WhatsApp:', whatsapp)
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                                    ...
                                    {activeSection === 'whatsapp' && (
                                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
                                            ...
                                            <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                                                <Button onClick={handleUpdateWhatsapp} className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-xl h-12">
